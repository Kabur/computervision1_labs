function [optical_flow] = lucas_kanade(I1, I2, window_size, cols, rows)
...
%             'Skipping a corner too close to the edge'
% 			continue;
%         end
...
% 		b = - reshape(region2 - region1, [window_size*window_size, 1]);
% 		v = mldivide(At*A, At*b);
% 		optical_flow(row_iter, col_iter, :) = v;
% 	end
% end
